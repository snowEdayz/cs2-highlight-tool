...
- 更新提示中"前往下载"按钮现在直接跳转资产下载链接（中国大陆走镜像、其他地区走 GitHub）
...
- Recording settings: shoulder camera toggle to enable an over-the-shoulder third-person view in recording scripts
...
- The "Open Download" button on the update prompt now opens the direct asset download link (mirror for CN, GitHub for others) instead of the release page
